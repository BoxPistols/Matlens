...
import { ProgressBar, Typing, Kbd, Divider } from './atoms';
  ...
  render: () => (
    <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
        ...
        <span style={{ fontSize: 12, color: 'var(--text-lo)' }}>AI</span>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
        <Typing color="var(--vec)" />
        <span style={{ fontSize: 12, color: 'var(--text-lo)' }}>Vec</span>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
        <Typing color="var(--accent)" />
        <span style={{ fontSize: 12, color: 'var(--text-lo)' }}>Accent</span>
      </div>
    </div>
  ),
};
