...
| 受託試験 PoC (Signature Screens) | 受託試験ダッシュボード / 試験マトリクス / 損傷ギャラリー / 横断セマンティック検索 / 案件一覧・詳細 / 試験片トラッカー / 材料マスタ |
...
| 項目 | 数 |
|------|-----|
| ページ数 | 26 (受託試験 PoC Signature Screens + 切削条件エクスプローラ + 試験片トラッカー + 受託試験ダッシュボード + 材料マスタ含む) |
